    ...
    <AnimatePresence>
      {menuValue && (
        <motion.div
          ...
          exit={{ top: '100vh' }}
          key={1}
          className=" section-blur-overlay text-white font-semibold bg-black/90 fixed h-full w-full top-0 left-0 z-[999] flex flex-col  justify-center items-start px-5"
        >
